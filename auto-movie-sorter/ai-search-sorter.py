...
def sorter(name):
    for i in name:
        ...
        data_search = client.search(i)["results"]
        print(data_search)
        ...
        payload = {
            ...
            "prompt": f"Information: {data_search} \n\n Using the information, answer the following, Give me one word response, is this a movie, anime, series, game",
            "stream": False
        }
        headers = {
        ...
        if "Movie" in type or "movie" in type:
